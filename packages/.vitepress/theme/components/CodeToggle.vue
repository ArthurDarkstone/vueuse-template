...
const preferJS = useStorage('utils-prefer-js', false)

watchEffect(() => {
  if (typeof window !== 'undefined')
    document.body.classList.toggle('utils-prefer-js', preferJS.value)
})
</script>
...
<style>
body.utils-prefer-js .code-block-ts {
  display: none;
}

body:not(.utils-prefer-js) .code-block-js {
  display: none;
}
